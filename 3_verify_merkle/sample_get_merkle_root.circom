...
// k is depth of tree
    ...
    merkle_root[0].in[0] <== paths2_root[0] - paths2_root_pos[0]* (paths2_root[0] - leaf); // path2_root if 0 elif 1 leaf
    merkle_root[0].in[1] <== leaf - paths2_root_pos[0]* (leaf - paths2_root[0]); // path2_root if 1 elif 0 leaf
    merkle_root[0].k <== 0; 
